...
def paint_pizza_image(toppings, img_gen_model):
    st.image(generate_pizza_image(toppings, img_gen_model), width=400)
    if not mock:
...
def app_main_frame(pizza_config, predicted_price, img_gen_model):
    ...
    paint_pizza_image(pizza_config.toppings, img_gen_model)
